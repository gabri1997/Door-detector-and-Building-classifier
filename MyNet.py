...
"""Codice copiato e modificato da noi per utilizzarlo nel nostro caso specifico"""
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = self.fc(features)
        #Abbiamo aggiunto la variabile FEATURES che andremo ad utilizzare per fare retrieval
        return x, features
